...
public class Clase16 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Clase 16:Trabajando con Sets e Iterators !!!\n");
		...
		System.out.println("Clase 16:Imprimiendo Listado de Alumnos!!!\n");
		curso1.getAlumnos().forEach(alumno -> System.out.println("Alumno :"+alumno));
		
		System.out.println("\nClase 16:Usando Iteraros!!!\n");
		...
		System.out.println("\nClase 16:Error ya que el iterator fue recorrido en su Totalidad!!!\n");
		alumnoIterator.next();
